<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="restraunt_employee.aspx.cs" Inherits="restraunt.restraunt_employee" %>
...
<head runat="server">
    <meta charset="utf-8"/>
    <title>Restraunt Employee</title>
...
<body style="background:url('img/header-bg.jpg') fixed;">
    <form id="form1" runat="server">
        <div>
            ...
            <!-- Services Section -->
            <div id="services-section-restraunt-employee" class="text-center" >
                <div class="container">
                    <div class="section-title wow fadeInDown">
                        <!-- hr -->
                        <hr style="width:32%;background-color:#f7dc6f;height:4px;border-radius:15px;"/>
                        <h2>Restraunt <strong>Employee</strong></h2>
                        <!-- hr -->
                        <hr style="width:32%;background-color:#f7dc6f;height:4px;border-radius:15px;"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 service wow fadeInUp" data-wow-delay="400ms">
                            <a runat="server" onserverclick="student_info_second_Click"><i class="fa fa-gears"></i></a>
                        ...
                        <div class="col-md-4 col-sm-12 service wow fadeInUp" data-wow-delay="600ms">
                            <a runat="server" onserverclick="check_for_reseve_second_Click"><i class="fa fa-bullhorn"></i></a>
                            <h4><strong>Check For Reseve <br />  <br /> </strong></h4>
                            <p style="color:#d4ec73">Lorem ipsum dolor sit amet placerat facilisis felis mi in tempus eleifend pellentesque natoque etiam.</p>
                        </div>
                        <div class="col-md-4 col-sm-12 service wow fadeInUp" data-wow-delay="600ms">
                            <a runat="server" onserverclick="quick_checker_Click"><i class="fa fa-bullseye fa-5x"></i></a>
                            <h4><strong>Quick Checker<br />  <br /> </strong></h4>
                            <p style="color:#d4ec73">Lorem ipsum dolor sit amet placerat facilisis felis mi in tempus eleifend pellentesque natoque etiam.</p>
                        </div>
