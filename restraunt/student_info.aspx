<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_info.aspx.cs" Inherits="restraunt.student_info" %>
            ...
            <div id="services-section-city-employee" class="text-center" style="height:auto;padding-bottom:0px;margin-bottom:34px;padding-top:50px;">
                <div class="container">
                    <div class="section-title wow fadeInDown">
                        ...
                        <h2>Student <strong>Information</strong></h2>
                        <!-- hr -->
                        <hr style="width: 23%; background-color: #f7dc6f; height: 4px; border-radius: 15px;" />
                    ...
                    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                        ...
                        <asp:View ID="View1" runat="server">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <asp:Button ID="Button1" ValidationGroup="a" runat="server" OnClick="btn1_Click" Text="Next" Style="margin-left:50%;color: white; font-size: 25px; margin-bottom: 10px; background-color: rgba(8, 8, 8, 0.75); border-radius: 15px; border: 0; width: 100%;" />
                                </div>
