<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_employee.aspx.cs" Inherits="restraunt.manager_employee" %>
            ...
            <div id="services-section-city-employee" class="text-center">
                <div class="container">
                    <div class="section-title wow fadeInDown">
                        ...
                        <h2>Manager <strong>Area</strong></h2>
                        <!-- hr -->
                        <hr style="width: 23%; background-color: #f7dc6f; height: 4px; border-radius: 15px;" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 service wow fadeInUp" data-wow-delay="200ms">
                            <a runat="server" onserverclick="quick_reseve_Click"><i class="fa fa-desktop"></i></a>
                            <h4><strong>Qick Checker 
                                <br />
                                <br />
                                </strong></h4>
                        ...
                        <div class="col-md-3 col-sm-6 service wow fadeInUp" data-wow-delay="800ms">
                            <a runat="server" onserverclick="add_student_Click"><i class="fa fa-rocket"></i></a>

                            <h4><strong>Add Student
                                <br />
                                <br />
                            </strong></h4>
                            <p style="color: #d4ec73">Lorem ipsum dolor sit amet placerat facilisis felis mi in tempus eleifend pellentesque natoque.</p>
