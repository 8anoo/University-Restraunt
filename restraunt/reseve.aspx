<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reseve.aspx.cs" Inherits="restraunt.reseve" EnableEventValidation="true" %>
            ...
            <div id="services-section-city-employee" class="text-center" style="height:auto;padding-bottom:0px;margin-bottom:34px;padding-top:50px;">
                <div class="container">
                    <div class="section-title wow fadeInDown">
                        ...
                        <h2>Student <strong>Reseve</strong></h2>
                        <!-- hr -->
                        <hr style="width: 23%; background-color: #f7dc6f; height: 4px; border-radius: 15px;" />
                                    ...
                                    <div class="center-block" style="width: 60%; height: auto; background-color: rgba(88, 80, 80, 0.55); border-radius: 20px;">
                                        ...
                                        <div class="row" style="padding: 20px">
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                <legend class="text-center;" style="color: #ecc320; margin-top: 30px;">Information</legend>
                                            </div>
                                            ...
                                            <div class="row" style="padding-left: 2%;">
                                                ...
                                                <div class="col-md-8 col-xs-12" style="float: right; margin-bottom: 15px;">
                                                    <input readonly="true" id="txtbox_college" runat="server" class="txt_reseve" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="padding-left: 2%;">
                                                ...
                                                <div class="col-md-8 col-xs-12" style="float: right; margin-bottom: 15px;">
                                                    <input readonly="true" id="txtbox_room" runat="server" class="txt_reseve" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="padding-left: 2%;">
                                                ...
                                                <div class="col-md-8 col-xs-12" style="float: right; margin-bottom: 15px;">
                                                    <input readonly="true" id="txtbox_stage" runat="server" class="txt_reseve" />
                                                </div>
                                            </div>
                                            <!-- ================================== -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-6">
                                                            ...
                                                            <asp:CheckBoxList ID="CheckBoxList1" runat="server" class="days_of_week">
                                                                <asp:ListItem>saterday</asp:ListItem>
                                                            ...
                                                            <asp:Button ID="Button5" runat="server" OnClick="btn5_Click" Style="color: white; font-size: 14px; margin-bottom: 10px; background-color: rgba(8, 8, 8, 0.75); border-radius: 15px; border: 0; width: 35%;" Text="Select All" />
                                                        </div>
                                                        <div class="col-xs-6">
                                                            ...
                                                            <asp:Button ID="Button6" runat="server" OnClick="btn6_Click" Style="color: white; font-size: 14px; margin-bottom: 10px; background-color: rgba(8, 8, 8, 0.75); border-radius: 15px; border: 0; width: 35%;" Text="Select All" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </fieldset>
                                        ...
                                        <!--</div>-->
                                        <!-- btn calc all -->
                                        <asp:Button ID="Button4" runat="server" OnClick="btn4_Click" Style="color: white; font-size: 25px; margin-bottom: 10px; background-color: rgba(8, 8, 8, 0.75); border-radius: 15px; border: 0; width: 35%;" Text="Calc" />
                                        ...
                                        <!-- end test2 -->
                                        <asp:Button ID="Button3" runat="server" OnClick="btn3_Click" Style="color: white; font-size: 25px; margin-bottom: 10px; background-color: rgba(8, 8, 8, 0.75); border-radius: 15px; border: 0; width: 35%;" Text="Save" />
                                    </div>
                                </div>
                            </div>
                        </asp:View>
