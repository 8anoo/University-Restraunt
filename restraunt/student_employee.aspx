<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_employee.aspx.cs" Inherits="restraunt.student_employee" %>
            ...
            <div id="services-section-city-employee" class="text-center">
                <div class="container">
                    <div class="section-title wow fadeInDown">
                        ...
                        <h2>Student <strong>Area</strong></h2>
                        <!-- hr -->
                        <hr style="width: 23%; background-color: #f7dc6f; height: 4px; border-radius: 15px;" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 service wow fadeInUp" data-wow-delay="800ms">
